...
class PageAllocator {
 public:
  ...
  // Returns nullopt if no degraded replica can be loaded (any worker pressure
  // >= 1).
  ...
  // Caller provides a ratio in [0, 1], e.g.
 ...
 private:
  ...
  std::unordered_map<std::string,
                     std::unordered_map<int32_t, const BlockManager*>>
